...
app.controller('schemaEdit',function($scope,$http,schemaInstance,schemaByNameById, schemaByName ,dataTable,$filter){
    ...
    $scope.testAdd = function(){
        $scope.testzhou = {};
        $scope.testzhou.id = 3;
        $scope.testzhou.appSpace = "Content.XEDU";
        $scope.testzhou.name = "testzhou";
        $scope.testzhou.path = "survey";
        $scope.testzhou.data = "JsonString";
        schemaByNameById.put({NAME:"Form",ID:$scope.testzhou.id},$scope.testzhou);
    }
    $scope.testModify = function(){
        $scope.testzhou = {};
        $scope.testzhou.id = 2;
        $scope.testzhou.appSpace = "Content.XEDU";
        $scope.testzhou.name = "testzhoumodify";
        $scope.testzhou.path = "survey";
        $scope.testzhou.data = "JsonString";
        schemaByNameById.save({NAME:"Form",ID:$scope.testzhou.id},$scope.testzhou);
    }
    $scope.testDelete = function(){
        $scope.testzhou = {};
        $scope.testzhou.id = 2;
        schemaByNameById.remove({NAME:"Form",ID:$scope.testzhou.id});
    }
    $scope.testAdd2 = function(){
        $scope.testzhou = {};
        $scope.testzhou.id = 6;
        $scope.testzhou.name = "zhou";
        $scope.testzhou.mobile = "12345678900";
        $scope.testzhou.email = "zhou@cffex.com";
        $scope.testzhou.question1 = 26;
        $scope.testzhou.question2= 8;
        dataTable.put({NAME:"Survey",ID:$scope.testzhou.id},$scope.testzhou);
    }
